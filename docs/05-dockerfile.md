...
> 실제 빌드/실행 명령과 결과 로그, 포트 접속 증거, 삭제/정리는 [06 이미지 빌드](06-image-build.md), [07 포트 매핑](07-port.md), [08 커스텀 이미지 삭제 및 정리](08-cleanup.md)에서 다룸. 이 문서(05)는 Dockerfile 작성 자체(베이스 선택 이유, 지시어별 역할, 커스텀 포인트)에 집중함
